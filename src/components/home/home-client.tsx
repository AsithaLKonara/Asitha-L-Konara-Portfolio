...
import { TestimonialCard, type TestimonialCardData } from "@/components/testimonial-card";
...
export interface HomeClientProps {
  featuredProjects: ProjectCardProject[];
  services: ServiceCardData[];
  testimonials: TestimonialCardData[];
  articles: ArticlePreview[];
}

export function HomeClient({ featuredProjects, services, testimonials, articles }: HomeClientProps) {
  return (
    <div className="bg-[radial-gradient(ellipse_at_top,rgba(10,12,18,1)_0%,rgba(6,7,11,1)_40%)]">
      <main className="mx-auto max-w-6xl px-6 py-16 text-slate-200">
        ...
        <section className="mt-20 space-y-6">
          ...
          <div className="text-right">
            <Link href="/services" className="text-sm font-medium text-cyan-300 transition hover:text-cyan-200">
        ...
        <section className="mt-20 space-y-6">
          <SectionHeading
            ...
            description="Signals from founders, product leads, and collaborators on the impact of automation-first platforms we shipped."
          />
          <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="text-right">
            <Link href="/testimonials" className="text-sm font-medium text-cyan-300 transition hover:text-cyan-200">
        ...
        <section className="mt-20 space-y-6">
          ...
          <div className="text-right">
            <Link href="/blog" className="text-sm font-medium text-cyan-300 transition hover:text-cyan-200">
